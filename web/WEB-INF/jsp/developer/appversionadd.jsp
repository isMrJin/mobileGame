    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <form class="form-horizontal form-label-left" action="appVersionAdd" method="post" enctype="multipart/form-data">
           <input type="hidden" name="appid" name="appid" value="${appVersion}">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="file" class="form-control col-md-7 col-xs-12" name="PicId" id="a_downloadLink"  required="required"/>
            ${fileUploadError }
            </div>
          </div>
